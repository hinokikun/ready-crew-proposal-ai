...
Ready Crew の案件概要から、Web制作会社向けの営業提案書を自動作成するWebサービスです。
...
画面の「まずはサンプルで体験」を押すと、サンプル案件で要約PPTダウンロードまでの流れを確認できます。

### 提出前チェック

提案書作成後に、以下の提出前チェックリストを表示します。
...
管理者メニュー内に、社内試験導入で確認する項目をまとめています。
...
画面内の「このツールの効果」から、以下を折りたたみ表示できます。
