...
def add_missing_columns() -> None:
    with get_db() as db:
        ...
        _ensure_column(db, "users", "password_change_required", "INTEGER NOT NULL DEFAULT 0")
        ...
        _ensure_column(db, "audit_logs", "error_type", "TEXT NOT NULL DEFAULT ''")
        _ensure_column(db, "audit_logs", "http_status", "INTEGER NOT NULL DEFAULT 0")
