...
def _schema_statements() -> list[str]:
    ...
    return [
        ...
        CREATE TABLE IF NOT EXISTS proposal_histories (
            ...
            proposal_generation_duration_ms INTEGER NOT NULL DEFAULT 0,
            powerpoint_generation_duration_ms INTEGER NOT NULL DEFAULT 0,
              beautiful_ai_generation_duration_ms INTEGER NOT NULL DEFAULT 0,
              pdf_generation_duration_ms INTEGER NOT NULL DEFAULT 0,
        ...
        """,
        f"""
        CREATE TABLE IF NOT EXISTS business_improvement_reports (
            id {id_column},
            user_id INTEGER,
            project_id INTEGER,
              project_name TEXT NOT NULL DEFAULT '',
              before_minutes REAL NOT NULL DEFAULT 0,
              after_minutes REAL NOT NULL DEFAULT 0,
              ai_input_minutes REAL NOT NULL DEFAULT 0,
              ai_wait_minutes REAL NOT NULL DEFAULT 0,
              revision_minutes REAL NOT NULL DEFAULT 0,
              review_minutes REAL NOT NULL DEFAULT 0,
              total_after_minutes REAL NOT NULL DEFAULT 0,
              saved_minutes REAL NOT NULL DEFAULT 0,
              reduction_rate REAL NOT NULL DEFAULT 0,
        ...
        """,
        f"""
        CREATE TABLE IF NOT EXISTS proposal_agent_memories (
            id {id_column},
            user_id INTEGER,
            project_id INTEGER,
            project_name TEXT NOT NULL DEFAULT '',
            hearing_notes TEXT NOT NULL DEFAULT '',
            confirmation_items TEXT NOT NULL DEFAULT '',
            proposal_content TEXT NOT NULL DEFAULT '',
            competitor_analysis TEXT NOT NULL DEFAULT '',
            improvement_history TEXT NOT NULL DEFAULT '',
            organization_id INTEGER NOT NULL DEFAULT 1,
            workspace_id INTEGER NOT NULL DEFAULT 1,
            created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
            updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
