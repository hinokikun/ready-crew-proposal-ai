...
type AutoFlowStatus = "idle" | "typing" | "analyzing" | "question" | "reviewing" | "generating" | "complete";
...
function buildAutoFlowMessage(status: AutoFlowStatus, result: AnalysisResponse | null, question?: ChatQuestion) {
  ...
  switch (status) {
    ...
    case "reviewing":
      return "内容を確認しました。このまま提案書を作成します。";
    case "generating":
      return "提案書を作成中です。";
    case "complete":
          ...
          {!result && (
            <>
              ...
              {autoFlowStatus === "reviewing" && (
                <div className="wizard-review-card" aria-label="生成前確認">
                  <div>
                    <strong>生成前の確認</strong>
