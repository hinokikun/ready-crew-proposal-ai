  ...
  return (
    ...
    <main className={`app-shell ${isDarkMode ? "dark-mode" : ""}`}>
      ...
      <section className="one-screen-start" aria-label="初期入力">
        ...
        <label className="field one-screen-input">
        ...
        <div className="one-screen-actions">
          <button className="primary-button" type="button" onClick={oneClickAutoGenerate} disabled={!canGenerate || isLoading}>
      ...
      <details className="advanced-foldout ai-functions-menu">
      ...
      <details className="advanced-foldout admin-menu-foldout">
...
CMSはWordPress希望。競合：https://example.co.jp"
      ...
      {activeMode === "sales" && (
      <details className="advanced-foldout result-foldout" id="result-sales-panel">
