            ...
            <div className="wizard-action-panel">
              <div className="wizard-primary-actions">
                ...
                <button
                  ...
                  disabled={!isBeautifulAiReady || !canDownloadMainOutputs || isDownloadingPowerPoint || isDownloadingSummaryPowerPoint || isDownloadingEstimatePdf || isCreatingBeautifulAi}
                >
                ...
                {!isBeautifulAiReady && <p className="beautiful-ai-unset">{beautifulAiUnavailableMessage}</p>}
                {beautifulAiResult && (
